package com.faasadmin.faas.modules.admin.tool.controller.test;
...
import com.faasadmin.faas.services.tool.vo.test.*;
...
public class ToolTestDemoController {
    ...
    @Resource
    private ToolTestDemoWebService testDemoService;
