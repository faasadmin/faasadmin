package com.faasadmin.faas.modules.admin.admin.controller.system.region;

import cn.hutool.core.lang.tree.Tree;
import com.faasadmin.faas.business.expand.service.region.SysRegionBussService;
...
public class SysRegionController {
    ...
    @Resource
    private SysRegionBussService sysRegionBussService;
    ...
    public CommonResult<List<Tree<String>>> getTreeRegion() {
        return success(sysRegionBussService.listRegionTree());
    }
