...
import com.faasadmin.faas.business.core.module.system.service.logger.SysLoginLogBussService;
...
public class SysLoginLogController {
    ...
    @Resource
    private SysLoginLogBussService sysLoginLogBussService;
    ...
    public CommonResult<PageResult<SysLoginLogRespVO>> getLoginLogPage(@Valid SysLoginLogPageReqVO reqVO) {
        PageResult<SysLoginLogDO> page = sysLoginLogBussService.getLoginLogPage(reqVO);
    ...
    public void exportLoginLog(HttpServletResponse response, @Valid SysLoginLogExportReqVO reqVO) throws IOException {
        List<SysLoginLogDO> list = sysLoginLogBussService.getLoginLogList(reqVO);
        // 拼接数据
