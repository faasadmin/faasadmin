...
import com.faasadmin.faas.services.system.enums.business.common.SysSexEnum;
    ...
    public void importTemplate(HttpServletResponse response) throws IOException {
        ...
        List<SysUserImportExcelVO> list = Arrays.asList(
                SysUserImportExcelVO.builder().userName("faasadmin").deptId(1L).email("codezhifu@163.com").mobile("100101691300")
                        .nickName("faasadmin").status(CommonStatusEnum.ENABLE.getStatus()).sex(SysSexEnum.MALE.getSex()).build(),
