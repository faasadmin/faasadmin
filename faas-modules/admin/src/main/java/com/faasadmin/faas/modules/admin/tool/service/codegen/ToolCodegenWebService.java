package com.faasadmin.faas.modules.admin.tool.service.codegen;
 ...
 * @author faasadmin
 */
public interface ToolCodegenWebService {
     ...
     * @return 生成结果。key 为文件路径，value 为对应的代码内容
     */
    Map<String, String> batchGenerationCodes(String[] tableIds);
