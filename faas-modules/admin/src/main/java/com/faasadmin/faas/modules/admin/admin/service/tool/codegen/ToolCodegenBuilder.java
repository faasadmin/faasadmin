...
package com.faasadmin.faas.modules.admin.admin.service.tool.codegen;
...
import com.faasadmin.faas.services.tool.enums.codegen.ToolCodegenColumnHtmlTypeEnum;
import com.faasadmin.faas.services.tool.enums.codegen.ToolCodegenColumnListConditionEnum;
import com.faasadmin.faas.services.tool.enums.codegen.ToolCodegenTemplateTypeEnum;
...
public class ToolCodegenBuilder {
    ...
    private static final Map<String, Set<String>> javaTypeMappings = MapUtil.<String, Set<String>>builder()
            ...
            .put(Object.class.getSimpleName(),Sets.newHashSet("json"))
            .build();
