...
import com.faasadmin.faas.business.core.module.system.service.sms.SysSmsLogBussService;
...
public class SysSmsLogController {
    ...
    @Resource
    private SysSmsLogBussService sysSmsLogBussService;
    ...
    public CommonResult<PageResult<SysSmsLogRespVO>> getSmsLogPage(@Valid SysSmsLogPageReqVO pageVO) {
        PageResult<SysSmsLogDO> pageResult = sysSmsLogBussService.getSmsLogPage(pageVO);
    ...
    public void exportSmsLogExcel(@Valid SysSmsLogExportReqVO exportReqVO,
        ...
        List<SysSmsLogDO> list = sysSmsLogBussService.getSmsLogList(exportReqVO);
        // 导出 Excel
