package com.faasadmin.faas.modules.admin.admin.controller.system.logger;

import com.faasadmin.faas.business.core.module.system.service.logger.SysOperateLogBussService;
...
public class SysOperateLogController {
    ...
    @Resource
    private SysOperateLogBussService sysOperateLogBussService;
    @Resource
    ...
    public CommonResult<PageResult<SysOperateLogRespVO>> pageOperateLog(@Valid SysOperateLogPageReqVO reqVO) {
        PageResult<SysOperateLogDO> pageResult = sysOperateLogBussService.getOperateLogPage(reqVO);
    ...
    public void exportOperateLog(HttpServletResponse response, @Valid SysOperateLogExportReqVO reqVO) throws IOException {
        List<SysOperateLogDO> list = sysOperateLogBussService.getOperateLogs(reqVO);
