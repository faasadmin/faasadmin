    ...
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="存储器" prop="storage">
        <el-select v-model="queryParams.storage" placeholder="请选择存储器" clearable>
          <el-option v-for="dict in this.getDictDatas(DICT_TYPE.SYS_FILE_STORAGE)"
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd"
                   v-hasPermi="['system:file-config:create']">新增</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="list">
      ...
      <el-table-column label="存储器" align="center" prop="storage">
        <template slot-scope="scope">
          <dict-tag :type="DICT_TYPE.SYS_FILE_STORAGE" :value="scope.row.storage" />
        </template>
      </el-table-column>
      <el-table-column label="备注" align="center" prop="remark" />
      <el-table-column label="主配置" align="center" prop="primary">
        <template slot-scope="scope">
          <dict-tag :type="DICT_TYPE.SYS_BOOLEAN_STRING" :value="scope.row.master" />
        </template>
      </el-table-column>
