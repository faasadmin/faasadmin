      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button size="mini" type="text" icon="el-icon-delete" @click="handleDelete(scope.row)"
                     v-hasPermi="['system:db:file:delete']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    <!-- 分页组件 -->
...
<script>
import { deleteFile, getFilePage } from "@/api/system/dbFile";
...
export default {
  ...
  data() {
    return {
      getFileUrl: process.env.VUE_APP_BASE_API + '/api/system/db/file/download/',
      // 遮罩层
      loading: true,
      // 显示搜索条件
      showSearch: true,
      ...
      upload: {
        ...
        url: process.env.VUE_APP_BASE_API + '/api/' + "/system/db/file/upload", // 请求地址
