...
export const DICT_TYPE = {
  ...
  SYS_COMMON_VISIBLE: 'sys_common_visible',
  ...
  SYS_MENU_ASCRIPTION: 'sys_menu_ascription',
  SYS_OSS_TYPE:'sys_oss_type',
  APP_MARKT_PLATFORM:'app_markt_platform',
  APP_MARKT_ENCRYPT:'app_markt_encrypt',

  SAAS_LESSEE_TYPE: 'saas_lessee_type',
  SAAS_INIT_TYPE: 'saas_init_type',
